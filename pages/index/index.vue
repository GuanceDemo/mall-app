<template>
	<view class="container">
		...
		<view class="mp-search-box">
			<input class="ser-input" type="text" value="{{ global.language.searchInput }}" disabled />
		</view>
		<!-- #endif -->
		...
		<view class="cate-section">
			<view class="cate-item">
				...
				<text>{{global.language.specialTopics}}</text>
			</view>
			<view class="cate-item">
				<image src="/static/temp/c5.png"></image>
				<text>{{global.language.topics}}</text>
			</view>
			<view class="cate-item">
				<image src="/static/temp/c6.png"></image>
				<text>{{global.language.preferred}}</text>
			</view>
			<view class="cate-item">
				<image src="/static/temp/c7.png"></image>
				<text>{{global.language.specialOffers}}</text>
			</view>
		</view>
		<!-- 品牌制造商直供 -->
		<view class="f-header m-t" @click="navToRecommendBrandPage()">
			...
			<view class="tit-box">
				<text class="tit">{{ global.language.brandTitle }}</text>
				<text class="tit2">{{ global.language.brandDes }}</text>
			</view>
		...
		<view class="guess-section">
			<view v-for="(item, index) in brandList" :key="index" class="guess-item" @click="navToBrandDetailPage(item)">
				...
				<text class="title2">{{ global.language.totalNumber }}：{{item.productCount}}</text>
			</view>
		</view>
		...
		<view class="f-header m-t" v-if="homeFlashPromotion!==null">
			...
			<view class="tit-box">
				<text class="tit">{{ global.language.flashTitle }}</text>
				<text class="tit2">{{ global.language.next }} {{homeFlashPromotion.nextStartTime | formatTime}} {{ global.language.start }}</text>
			</view>
			<view class="tit-box">
				<text class="tit2" style="text-align: right;">{{ global.language.flashEnd }}</text>
		...
		<view class="f-header m-t" @click="navToNewProudctListPage()">
			...
			<view class="tit-box">
				<text class="tit">{{ global.language.newProduct }}</text>
				<text class="tit2">{{ global.language.newProductDes }}</text>
			</view>
			<text class="yticon icon-you"></text>
		</view>
		...
		<view class="f-header m-t" @click="navToHotProudctListPage()">
			...
			<view class="tit-box">
				<text class="tit">{{ global.language.hotProduct }}</text>
				<text class="tit2">{{ global.language.hotProductDes }}</text>
			</view>
			<text class="yticon icon-you"></text>
		</view>
		...
		<view class="f-header m-t">
			...
			<view class="tit-box">
				<text class="tit">{{ global.language.recommendProduct }}</text>
				<text class="tit2">{{ global.language.recommendProductDes }}</text>
			</view>
			<text class="yticon icon-you" v-show="false"></text>
		</view>
